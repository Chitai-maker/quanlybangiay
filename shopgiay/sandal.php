...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center mb-4">
            ...
            ?>
                    <form method="get" action="sandal.php" class="mx-2">
    ...
    <div class="container" style="margin-top: 50px;">
        ...
        if (isset($_GET['mamaugiay'])) {
            ...
            $query = "SELECT * FROM giay WHERE maloaigiay = 2 AND mamaugiay = '$mamaugiay'";
        } else {
            $query = "SELECT * FROM giay WHERE maloaigiay = 2";
        }
